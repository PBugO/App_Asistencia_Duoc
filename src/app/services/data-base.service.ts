...
export class DataBaseService {
  ...
  // REGISTRA USUARIO PARA PAGINA REGISTRO
  async crearUsuarioConDatos(usuario: string, password: string, nombre: string, apellido: string,
    preguntaSecreta: string, respuestaSecreta: string, sesionActiva: string): Promise<void> {
